...
- [x] **PRICING-1** Plan revamp: Free/Starter/Pro/Business/Enterprise — working ladder promoted in V2.11.0: Free €0 + €199/event; Starter €20/mo or €180/yr + €149/event; Pro €70/mo or €660/yr + €99/event; Business €150/mo or €1,440/yr + €95/event. Limits remain 1/10/20/40 events per month and 10/20/30/50 teams. Partner review may revise it in a later release. See `docs/PAYMENTS-AND-PLAN-ECONOMICS.md`.
- [ ] **L-2** AI features for clients (#24): bulk game creation, AI descriptions
- [~] **PAY-1 current:** Paddle subscription, event checkout, webhook, and per-event auto-charge paths have all been sandbox-tested successfully (confirmed by Rumen, 15 Jul 2026). Free is postpaid: its event goes live immediately, then an invoice is raised; another Free event is blocked while an earlier invoice is unpaid. Paid plans require an active paid-through subscription. Limits and friendly messages are server/UI enforced. V2.11.0 removes automatic first-event-free (selected clients use a 100% event promo), closes privileged invoice RPC direct access, and adds an in-app Starter/Pro/Business plan-change flow with Paddle proration preview and payment-failure protection. Plan changes remain feature-flagged off until live-payment verification. Full rules and unit economics: `docs/PAYMENTS-AND-PLAN-ECONOMICS.md`.
