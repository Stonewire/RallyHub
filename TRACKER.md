...
- [ ] **PAY-2 team/branding add-ons:** decide prices, create Paddle products, store purchased per-event capacity/branding entitlements, and extend the activation gate. Until then the database safely enforces the included 5-team maximum; no unpaid add-on capacity is granted.
