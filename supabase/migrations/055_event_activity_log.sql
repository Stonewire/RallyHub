-- Per-event activity log: teams joining, facilitator connects, stage advances, submissions, winner.
...
-- SECURITY DEFINER RPC so both anon (join token) and authenticated callers can write.
