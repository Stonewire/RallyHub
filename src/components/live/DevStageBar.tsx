...
import type { DevStageStep } from '@/lib/dev-stage-steps'

/**
 * Development-only stage driver, enabled with `?devbar=1`.
 *
 * Reviewing a live stage otherwise means running a facilitator console in
 * another window and keeping the two in step. This walks every screen the
...
export function DevStageBar({ steps, index, onGo, onReset }: Props) {
