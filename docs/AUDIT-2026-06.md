...
> **HISTORICAL RECORD.** The Fixed/Open statuses below predate the V2.0
> rollback (commit 7620371), which un-shipped several client-side fixes this
> audit counts as Fixed. The live checklist is `TRACKER.md` at the repo root;
> use this file only for the detailed background on a finding id (C1-C8,
> H1-H17, M*, L*).
